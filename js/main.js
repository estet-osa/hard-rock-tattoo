...
function show_video_wizard(wiz, videoID){
...
// 2. This code loads the IFrame Player API code asynchronously.
 ...
 var wizard = document.getElementById(wiz);
...
var video = document.getElementById('video_wizard');
  ...
  player = new YT.Player('video_wizard', {
    videoId: videoID,
    width: '100%',
    events: {
   'onReady':onPlayerReady,
...
function onYouTubePlayerAPIReady() {
	...
	var play = new YT.Player('video_wizard', {videoId: 'wN58untuftA',});
